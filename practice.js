...
function bindCard(makePerson, makeCard) {
  this.name = makePerson.name;
  this.birthday = makePerson.birthday;
  this.ssn = makePerson.ssn;
  this.cardNumber = makeCard.cardNumber;
  this.expirationDate = makeCard.expirationDate;
  this.securityCode = makeCard.securityCode;
  return this;
}
